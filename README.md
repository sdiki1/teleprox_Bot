...
- Новый flow покупки: выбор `месяцев` -> выбор `устройств` -> `себе или другу`.
- Для покупки другу можно указать `tg_user_id`, `@username` или отправить контакт.
...
- `/start` — главное меню
- `/plans` — начать покупку (выбор месяцев и устройств)
- `/buy` — начать покупку (выбор месяцев и устройств)
